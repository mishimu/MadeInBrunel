		...
		<div id="footer">
			<div class="col-245" id="copyrights">
				...
				<ul>
					<li>
						<a href="/">
							<img class="footer-logo" src="/wp-content/themes/mib/_images/site_mib_footer_logo.gif" alt="Made in Brunel logo" border="0" />
						</a>
					</li>
					<li>
						<a href="http://www.brunel.ac.uk" target="_blank">
							<img class="footer-logo" src="/wp-content/themes/mib/_images/site_brunel_footer_logo.png" alt="Brunel University" />
						</a>
					</li>
				</ul>				
			...
			<div id="twitter">
				<h2><a href="http://twitter.com/madeinbrunel12" target="_blank">@madeinbrunel12</a></h2>
			</div>
		</div>
	</div>
	<!-- Footer End -->
