...
<label for="author"><?php _e('Name', 'kubrick'); ?> <span class="required"><?php if ($req) _e("(required)", "kubrick"); ?></span></label>
<input type="text" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />

<label for="email"><?php _e('Mail <span class="small">(will not be published)</span>', 'kubrick'); ?> <span class="required"><?php if ($req) _e("(required)", "kubrick"); ?></span></label>
...
<label for="comment"><?php _e('Comment', 'kubrick'); ?></label>
